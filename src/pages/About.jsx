...
<h2 style={{ margin: 0 }}>Sobre <span style={{ color: "#2563eb" }}>Todo Útiles</span></h2>
<div style={{ color: palette.muted }}>Conectando la educación y la productividad desde 2005.</div>
</div>
...
<div style={{ height: 180, borderRadius: 12, background: "#e5e7eb" }} />
</div>
</div>
...
<div style={{ ...card, padding: 16, minHeight: 220 }} />
<div style={{ ...card, padding: 16 }}>
